...
typedef struct {
  ...
  PyObject *__pyx_kp_s_hello_there;
...
static int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_kp_s_hello_there);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_kp_s_hello_there);
...
#define __pyx_kp_s_hello_there __pyx_mstate_global->__pyx_kp_s_hello_there
 ...
 *     print("hello there, " + name + "!")             # <<<<<<<<<<<<<<
 */
  __pyx_t_1 = PyNumber_Add(__pyx_kp_s_hello_there, __pyx_v_name); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyNumber_Add(__pyx_t_1, __pyx_kp_s_); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 2, __pyx_L1_error)
